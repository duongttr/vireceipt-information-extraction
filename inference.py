...
os.environ["TESSDATA_PREFIX"] = "./models/tessdata/"
...
class LayoutLMv3:
    ...
    def predict(self, image_path, output_path=None):
        ...
        for box in bboxes:
            ...
            data = pytesseract.image_to_string(image_cropped, config='--oem 2 --psm 3', lang='vie', output_type=pytesseract.Output.DICT)
