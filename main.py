...
from process import InvoiceExtraction, Utils
...
# Enhance sharp
results['4. sharp'] = in_extract.enhance_sharp(
    np.array(results['3. contrast']), 3)
# Adap mean
results['5. adap mean'] = in_extract.adaptive_binary_image(
    results['3. contrast'], 'mean', 15, 11)
# Adap gaussian (Cái này tốt nhất nha)
results['6. adap gaussian'] = in_extract.adaptive_binary_image(
    results['3. contrast'], 'gaussian', 15, 11)
# Mean blur
